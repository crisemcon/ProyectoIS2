...
const ListaAlumnosContagiados = ({ alumnos, ...rest }) => {
            ...
            <TableBody>
              {alumnos.slice(0, limit).map((alumno) => (
                ...
                >
                  ...
                  <TableCell>{alumno.Fecha}</TableCell>
                  <TableCell>{alumno.Fecha_termino}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
...
ListaAlumnosContagiados.propTypes = {
  alumnos: PropTypes.array.isRequired,
};

export default ListaAlumnosContagiados;
